    ...
    namespace schemas {
        namespace client_dll {
            ...
            namespace C_EnvVolumetricFogVolume {
                constexpr std::ptrdiff_t m_bActive = 0x608;
                constexpr std::ptrdiff_t m_vBoxMins = 0x60C;
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x618;
                constexpr std::ptrdiff_t m_bStartDisabled = 0x624;
            ...
            namespace C_EnvVolumetricFogController {
                ...
                constexpr std::ptrdiff_t m_TintColor = 0x60C;
                ...
                constexpr std::ptrdiff_t m_vBoxMins = 0x63C;
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x648;
                constexpr std::ptrdiff_t m_bActive = 0x654;
                ...
                constexpr std::ptrdiff_t m_bStartDisabled = 0x67C;
                ...
                constexpr std::ptrdiff_t m_fNoiseStrength = 0x690;
                ...
                constexpr std::ptrdiff_t m_bFirstTime = 0x6B0;
            }
            ...
            namespace C_ColorCorrectionVolume {
                ...
                constexpr std::ptrdiff_t m_bEnabled = 0xF68;
            ...
            namespace CInfoDynamicShadowHintBox {
                constexpr std::ptrdiff_t m_vBoxMins = 0x620;
                constexpr std::ptrdiff_t m_vBoxMaxs = 0x62C;
            }
            ...
            namespace C_ColorCorrection {
                ...
                constexpr std::ptrdiff_t m_bEnabled = 0x82C;
                constexpr std::ptrdiff_t m_bMaster = 0x82D;
                ...
                constexpr std::ptrdiff_t m_flFadeDuration = 0x844;
            }
            ...
            namespace CEnvSoundscape {
                ...
                constexpr std::ptrdiff_t m_bDisabled = 0x684;
            ...
            namespace C_FogController {
                ...
                constexpr std::ptrdiff_t m_bUseAngles = 0x670;
            ...
            namespace C_InfoVisibilityBox {
                ...
                constexpr std::ptrdiff_t m_bEnabled = 0x61C;
            }
            ...
            namespace C_PathParticleRope {
                ...
                constexpr std::ptrdiff_t m_flRadius = 0x640;
                constexpr std::ptrdiff_t m_ColorTint = 0x644;
            ...
            namespace C_TonemapController2 {
                ...
                constexpr std::ptrdiff_t m_flTonemapEVSmoothingRange = 0x618;
            }
            ...
            namespace C_FuncLadder {
                ...
                constexpr std::ptrdiff_t m_bDisabled = 0xED8;
            ...
            namespace C_Hostage {
                constexpr std::ptrdiff_t m_entitySpottedState = 0x13D8;
                constexpr std::ptrdiff_t m_leader = 0x13F0;
                constexpr std::ptrdiff_t m_reuseTimer = 0x13F8;
                constexpr std::ptrdiff_t m_vel = 0x1410;
            ...
            namespace C_PlayerVisibility {
                ...
                constexpr std::ptrdiff_t m_bStartDisabled = 0x618;
            ...
            namespace C_EnvWindController {
                ...
                constexpr std::ptrdiff_t m_bIsMaster = 0x720;
                constexpr std::ptrdiff_t m_bFirstTime = 0x721;
            }
            ...
            namespace C_PointWorldText {
                ...
                constexpr std::ptrdiff_t m_flDepthOffset = 0x113C;
                ...
                constexpr std::ptrdiff_t m_Color = 0x1150;
            ...
            namespace CInfoDynamicShadowHint {
                constexpr std::ptrdiff_t m_bDisabled = 0x608;
                constexpr std::ptrdiff_t m_flRange = 0x60C;
            ...
            namespace C_Chicken {
                ...
                constexpr std::ptrdiff_t m_jumpedThisFrame = 0x13AC;
                constexpr std::ptrdiff_t m_leader = 0x13B0;
            ...
            namespace C_BaseClientUIEntity {
                constexpr std::ptrdiff_t m_bEnabled = 0xE90;
            ...
            namespace C_SoundEventSphereEntity {
                constexpr std::ptrdiff_t m_flRadius = 0x6B8;
            }
            ...
            namespace C_TriggerBuoyancy {
                constexpr std::ptrdiff_t m_BuoyancyHelper = 0xF58;
                constexpr std::ptrdiff_t m_flFluidDensity = 0x1070;
            }
            ...
            namespace C_EntityDissolve {
                ...
                constexpr std::ptrdiff_t m_flFadeInStart = 0xE94;
            ...
            namespace C_FuncMonitor {
                ...
                constexpr std::ptrdiff_t m_bEnabled = 0xEA4;
            ...
            namespace C_CSGO_TeamPreviewCharacterPosition {
                constexpr std::ptrdiff_t m_nVariant = 0x608;
            ...
            namespace C_SmokeGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_vSmokeColor = 0x145C;
            ...
            namespace C_DynamicProp {
                ...
                constexpr std::ptrdiff_t m_bStartDisabled = 0x135D;
            ...
            namespace C_TextureBasedAnimatable {
                constexpr std::ptrdiff_t m_bLoop = 0xE88;
            ...
            namespace C_BaseTrigger {
                ...
                constexpr std::ptrdiff_t m_iFilterName = 0xF48;
                constexpr std::ptrdiff_t m_hFilter = 0xF50;
                constexpr std::ptrdiff_t m_bDisabled = 0xF54;
            }
            ...
            namespace C_ParticleSystem {
                ...
                constexpr std::ptrdiff_t m_bActive = 0x1088;
                ...
                constexpr std::ptrdiff_t m_iEffectIndex = 0x1098;
                constexpr std::ptrdiff_t m_flStartTime = 0x10A0;
                ...
                constexpr std::ptrdiff_t m_bStartActive = 0x11DF;
                constexpr std::ptrdiff_t m_iszEffectName = 0x11E0;
            ...
            namespace C_BaseFlex {
                ...
                constexpr std::ptrdiff_t m_iEyeAttachment = 0x1285;
            ...
            namespace C_EnvCubemap {
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture = 0x688;
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x690;
                ...
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x6B0;
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x6B4;
                constexpr std::ptrdiff_t m_Entity_nEnvCubeMapArrayIndex = 0x6B8;
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x6BC;
                constexpr std::ptrdiff_t m_Entity_flEdgeFadeDist = 0x6C0;
                constexpr std::ptrdiff_t m_Entity_vEdgeFadeDists = 0x6C4;
                constexpr std::ptrdiff_t m_Entity_flDiffuseScale = 0x6D0;
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x6D4;
                ...
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x6E8;
            }
            ...
            namespace CCitadelSoundOpvarSetOBB {
                constexpr std::ptrdiff_t m_iszStackName = 0x620;
                constexpr std::ptrdiff_t m_iszOperatorName = 0x628;
                constexpr std::ptrdiff_t m_iszOpvarName = 0x630;
            ...
            namespace C_SceneEntity {
                ...
                constexpr std::ptrdiff_t m_hOwner = 0x61C;
            ...
            namespace C_EconEntity {
                ...
                constexpr std::ptrdiff_t m_bAttributesInitialized = 0x1370;
            ...
            namespace C_GradientFog {
                ...
                constexpr std::ptrdiff_t m_bHeightFogEnabled = 0x618;
                ...
                constexpr std::ptrdiff_t m_flFogMaxOpacity = 0x628;
                constexpr std::ptrdiff_t m_flFogFalloffExponent = 0x62C;
                constexpr std::ptrdiff_t m_flFogVerticalExponent = 0x630;
                constexpr std::ptrdiff_t m_fogColor = 0x634;
                constexpr std::ptrdiff_t m_flFogStrength = 0x638;
                constexpr std::ptrdiff_t m_flFadeTime = 0x63C;
                constexpr std::ptrdiff_t m_bStartDisabled = 0x640;
                constexpr std::ptrdiff_t m_bIsEnabled = 0x641;
            ...
            namespace C_FuncTrackTrain {
                ...
                constexpr std::ptrdiff_t m_flRadius = 0xE8C;
            ...
            namespace C_EnvDecal {
                ...
                constexpr std::ptrdiff_t m_flWidth = 0xE90;
                constexpr std::ptrdiff_t m_flHeight = 0xE94;
            ...
            namespace C_Beam {
                ...
                constexpr std::ptrdiff_t m_flDamage = 0xE94;
            ...
            namespace C_EnvLightProbeVolume {
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_AmbientCube = 0x1600;
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SDF = 0x1608;
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_DC = 0x1610;
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_R = 0x1618;
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_G = 0x1620;
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_B = 0x1628;
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture = 0x1630;
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture = 0x1638;
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture = 0x1640;
                constexpr std::ptrdiff_t m_Entity_vBoxMins = 0x1648;
                constexpr std::ptrdiff_t m_Entity_vBoxMaxs = 0x1654;
                constexpr std::ptrdiff_t m_Entity_bMoveable = 0x1660;
                constexpr std::ptrdiff_t m_Entity_nHandshake = 0x1664;
                constexpr std::ptrdiff_t m_Entity_nPriority = 0x1668;
                constexpr std::ptrdiff_t m_Entity_bStartDisabled = 0x166C;
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeX = 0x1670;
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeY = 0x1674;
                constexpr std::ptrdiff_t m_Entity_nLightProbeSizeZ = 0x1678;
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasX = 0x167C;
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasY = 0x1680;
                constexpr std::ptrdiff_t m_Entity_nLightProbeAtlasZ = 0x1684;
                constexpr std::ptrdiff_t m_Entity_bEnabled = 0x1691;
            }
            ...
            namespace C_PlantedC4 {
                ...
                constexpr std::ptrdiff_t m_AttributeManager = 0x11D0;
                ...
                constexpr std::ptrdiff_t m_pPredictionOwner = 0x16B8;
            ...
            namespace CFilterName {
                constexpr std::ptrdiff_t m_iFilterName = 0x640;
            }
            namespace C_RagdollProp {
                ...
                constexpr std::ptrdiff_t m_iEyeAttachment = 0x11C0;
            ...
            namespace C_LocalTempEntity {
                ...
                constexpr std::ptrdiff_t m_flFrameRate = 0x11BC;
                constexpr std::ptrdiff_t m_flFrame = 0x11C0;
            ...
            namespace C_CSGO_MapPreviewCameraPathNode {
                ...
                constexpr std::ptrdiff_t m_vInTangentLocal = 0x614;
                constexpr std::ptrdiff_t m_vOutTangentLocal = 0x620;
            ...
            namespace C_PointCamera {
                ...
                constexpr std::ptrdiff_t m_bActive = 0x624;
                ...
                constexpr std::ptrdiff_t m_flZFar = 0x634;
                constexpr std::ptrdiff_t m_flZNear = 0x638;
                constexpr std::ptrdiff_t m_bCanHLTVUse = 0x63C;
                constexpr std::ptrdiff_t m_bAlignWithParent = 0x63D;
                constexpr std::ptrdiff_t m_bDofEnabled = 0x63E;
                constexpr std::ptrdiff_t m_flDofNearBlurry = 0x640;
                constexpr std::ptrdiff_t m_flDofNearCrisp = 0x644;
                constexpr std::ptrdiff_t m_flDofFarCrisp = 0x648;
                constexpr std::ptrdiff_t m_flDofFarBlurry = 0x64C;
                constexpr std::ptrdiff_t m_flDofTiltToGround = 0x650;
            ...
            namespace C_BaseGrenade {
                ...
                constexpr std::ptrdiff_t m_flDamage = 0x1360;
                ...
                constexpr std::ptrdiff_t m_flNextAttack = 0x1394;
            ...
            namespace C_PlayerSprayDecal {
                ...
                constexpr std::ptrdiff_t m_vecLeft = 0xEB0;
                constexpr std::ptrdiff_t m_vecNormal = 0xEBC;
            ...
            namespace C_Sprite {
                ...
                constexpr std::ptrdiff_t m_flFrame = 0xE9C;
                ...
                constexpr std::ptrdiff_t m_flSpriteScale = 0xEB8;
                ...
                constexpr std::ptrdiff_t m_flScaleTimeStart = 0xEDC;
            ...
            namespace C_PointClientUIWorldPanel {
                constexpr std::ptrdiff_t m_bForceRecreateNextUpdate = 0xEC0;
                constexpr std::ptrdiff_t m_bMoveViewToPlayerNextThink = 0xEC1;
                constexpr std::ptrdiff_t m_bCheckCSSClasses = 0xEC2;
                constexpr std::ptrdiff_t m_anchorDeltaTransform = 0xED0;
                constexpr std::ptrdiff_t m_pOffScreenIndicator = 0x1060;
                constexpr std::ptrdiff_t m_bIgnoreInput = 0x1088;
                constexpr std::ptrdiff_t m_bLit = 0x1089;
                constexpr std::ptrdiff_t m_bFollowPlayerAcrossTeleport = 0x108A;
                constexpr std::ptrdiff_t m_flWidth = 0x108C;
                constexpr std::ptrdiff_t m_flHeight = 0x1090;
                constexpr std::ptrdiff_t m_flDPI = 0x1094;
                constexpr std::ptrdiff_t m_flInteractDistance = 0x1098;
                constexpr std::ptrdiff_t m_flDepthOffset = 0x109C;
                constexpr std::ptrdiff_t m_unOwnerContext = 0x10A0;
                constexpr std::ptrdiff_t m_unHorizontalAlign = 0x10A4;
                constexpr std::ptrdiff_t m_unVerticalAlign = 0x10A8;
                constexpr std::ptrdiff_t m_unOrientation = 0x10AC;
                constexpr std::ptrdiff_t m_bAllowInteractionFromAllSceneWorlds = 0x10B0;
                constexpr std::ptrdiff_t m_vecCSSClasses = 0x10B8;
